...
public class Home extends AppCompatActivity {
    RecyclerView recycleuudai119, recyclecapnhat119,recycle_lover119;
    itemAdapter itemAdapter119;
    @Override
...
//                        overridePendingTransition(0,0);
    ...
    public void setRecycle_uudai(List<item> itemList ){
        recycleuudai119=findViewById(R.id.recycle_uudai);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this,RecyclerView.HORIZONTAL,false);
        recycleuudai119.setLayoutManager(layoutManager);
        itemAdapter119 = new itemAdapter(this,itemList);
        recycleuudai119.setAdapter(itemAdapter119);
    }
    public void setRecyclecapnhat(List<item> itemList ){
        recyclecapnhat119=findViewById(R.id.recycle_capnhat);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this,RecyclerView.HORIZONTAL,false);
        recyclecapnhat119.setLayoutManager(layoutManager);
        itemAdapter119 = new itemAdapter(this,itemList);
        recyclecapnhat119.setAdapter(itemAdapter119);
    }
    public void setRecycle_lover(List<item> itemList ){
        recycle_lover119=findViewById(R.id.recycle_lover);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this,RecyclerView.HORIZONTAL,false);
        recycle_lover119.setLayoutManager(layoutManager);
        itemAdapter119 = new itemAdapter(this,itemList);
        recycle_lover119.setAdapter(itemAdapter119);
    }
}